...
<body>
                            ...
                            <div class="buttons">
                                ...
                                <div class="mix-input mix">
                                    ...
                                    <div class="right">
                                        <div class="form-group">
                                            <div class="error-container">
                                                <input type="text" name="total-sales" class="text"
                ...
                <div class="bot-side">
                    <div class="grid-table-container">
                        <div class="table-content">
                            ...
                            <?php echo CreateTable($TRANSACTIONHEADER, $TRANSACTIONBODY,  $TRANSACTIONS, "trans_id", 4, true) ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="module" src="./assets/js/sales_history.js"></script>
</body>
